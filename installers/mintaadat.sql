...
VALUES 
    (1, 'newUserName', 'newEmailgf@example.com', NULL, 'USER'),
    (2, 'newUserhhName', 'newEmailgggf@example.com', NULL, 'USER'),
    ...
    (1004, 'Zoltán Benedek', 'benedekzoltan2003@gmail.com', NULL, 'USER'),
    (1005, 'fiók plusz', 'pluszfiok001@gmail.com', NULL, 'USER'),
    (1006, 'Teszt profil', 'sajat.tesztprofil@gmail.com', NULL, 'USER');
GO
...
The bronze has a lovely, slightly aged patina, giving it an antique feel without appearing worn or damaged. The intricate details in the fur and facial features demonstrate the skill that went into its creation. It s small size makes it ideal for displaying on a desk, shelf, or curio cabinet. It is in excellent condition. This charming figurine is sure to bring a touch of wild beauty to any space.
